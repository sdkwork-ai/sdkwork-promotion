# Runbook — sdkwork-promotion deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-promotion-standalone:0.0.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-promotion/bundle`, loads the image, starts
...
bin/docker-deploy.sh rollback --environment staging --to 0.0.0       # explicit version
```
