...
Module `sdkwork-promotion` · runtime code `promotion` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `promotion-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `promotion-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `promotion-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `promotion-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `promotion.sdkwork.com` | 443 ssl + 80 |
